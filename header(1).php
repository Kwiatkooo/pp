...
//Here goes all the variables
	...
	while ($row= mysql_fetch_array($result)) 
	{
        ...
        $ToNextLvl1 = $ToNextLvl + $score;

        $ToNextLvl2 = $score / $ToNextLvl1 * 100;
...
$Online_Player_Game = mysql_num_rows(mysql_query('SELECT * FROM Online'));
$Online_Admin_Game = mysql_num_rows(mysql_query('SELECT * FROM Online WHERE Rangs= 7 or Rangs= 6 or Rangs= 5 or Rangs= 4 or Rangs= 3'));
$Online_Mod_Game = mysql_num_rows(mysql_query('SELECT * FROM Online WHERE Rangs= 2 or Rangs= 1'));
$Online_Vip_Game = mysql_num_rows(mysql_query('SELECT * FROM Online WHERE Vips= 1'));
?>	
<!DOCTYPE html>
<html>
...
function showHide(co)
{
 if(document.getElementById(co).style.display=="none")
  ...
  document.getElementById(co).style.display="none";
    ...
    <link href='<? echo "$domainname"; ?>/css/circle.css' media='all' rel='stylesheet' type='text/css' />   <!-- / flatty theme -->
...
<header>
                    ...
                    <li class="right">
						<div class="userloggedinfo">
							...
							<div class="userinfo">
								...
								<ul>
									<li><a href="profile.php"style="width: 170px;">Twój profil</a></li>
									<li><a href="#" onClick="showHide('jeden');"style="width: 170px;">Szukaj gracza</a> </li>
									<li><a href="/logout.php"style="width: 170px;">Wyloguj</a></li>
								</ul>
							</div>
						</div>
					</li>
	...
	<div class="inputz bounceIn" style="margin-left: 820px; margin-top: -10px;" >
...
<li class=''>
    <a href='<? echo "$domainname"; ?>/online.php'>
        <i class='icon-group'></i>
        <span>Lista Graczy Online</span>
    </a>
</li>
<li class=''>
...
<li class=''>
    <a href='<? echo "$domainname"; ?>/hause.php'>
        <i class='icon-home'></i>
        <span>Domy</span>
    </a>
</li>
