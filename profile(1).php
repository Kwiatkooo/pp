					...
					<h4 class="widgettitle">Profil > <a href="profile.php"><? echo "$name"; ?></a> > Sygnatury</h4>
                        <div class="widgetcontent nopadding">
                            <ul class="commentlist">
								...
								<img src='<? echo "$domainname"; ?>/signatures/s2.php?nick=<? echo "$userplayer"; ?>' style='width: 70%;'><br>
...
<div class="clearfix"style="margin-left: 10%;">
			                ...
			                <div class="c100 p<? echo floor("$ToNextLvl2"); ?> big ">
			                    <span><? echo floor("$ToNextLvl2"); ?></span>
			                    <div class="slice">
			                        <div class="bar"></div>
			                        <div class="fill"></div>
			                    </div>
