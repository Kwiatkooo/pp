...
$resultx = mysql_query($qadmins) or die(mysql_errno() . ": " . mysql_error() . "\n");
	while ($row= mysql_fetch_array($resultx))
	{
		...
		if ($admin=='1') {$ranga = "<span class='label label-jmod'>junio Moderator</span>";}
		if ($admin=='2') {$ranga = "<span class='label label-mod'>Moderator</span>";}
		if ($admin=='3') {$ranga = "<span class='label label-jadmin'>Junior-Administrator</span>";}
		if ($admin=='4') {$ranga = "<span class='label label-admin'>Administrator</span>";}
		if ($admin=='5') {$ranga = "<span class='label label-elite'>Elite Administrator</span>";}
		if ($admin=='6') {$ranga = "<span class='label label-vice'>junior Head Administrator</span>";}
